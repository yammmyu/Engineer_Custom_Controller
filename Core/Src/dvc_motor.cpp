...
/**
 * @brief Allocate Buffer Bits of CAN Transmit
 *
 * @param hcan CAN id
...
uint8_t *allocate_tx_data(CAN_HandleTypeDef *hcan, Enum_CAN_Motor_ID __CAN_ID)
{
    ...
    //     case (CAN_Motor_ID_0x208):
    //     {
    //         tmp_tx_data_ptr = &(CAN2_0x1ff_Tx_Data[6]);s
    //     }
    //     break;
    //     case (CAN_Motor_ID_0x209):
    //     {
 ...
 *
 * @param hcan CAN line being used (CAN1 or CAN2)
 * @param __CAN_ID CAN ID being used
 * @param __Control_Method Motor Control Method, (Default is Angle)
 * @param __Encoder_Offset Encoder Offest, (Default is 0)
 * @param __Omega_Max Maximum Output Angular Velocity allowed from the motor, used for open loop.
 */
...
/**
 * @brief Sending Output Data to CAN line transmit Buffer
 *
 */
 ...
 *
 * @return uint16_t maximum output Voltage
 */
 ...
 *
 * @return Enum_CAN_Motor_Status Motor Status
 */
...
/**
 * @brief Get Current Angle, rad
 *
 * @return float Current Angle, rad
 */
 ...
 *
 * @return float Current Angular Velocity, rad/s
 */
 ...
 *
 * @return uint8_t current temperature, C
 */
...
/**
 * @brief Get Motor Control Method
 *
 * @return Enum_Control_Method Motor Control Method
 */
...
/**
 * @brief Get Target Angle, rad
 *
 * @return float target Angle, rad
 */
...
/**
 * @brief Target Angular Velocity, rad/s
 *
 * @return float Target Angular Velocity, rad/s
 */
...
/**
 * @brief Set Control Method
 *
 * @param __Control_Method Control Method
 */
 ...
 *
 * @param __Target_Omega Target Angular Velocity, rad/s
 */
 ...
 *
 * @param __Target_Torque Target Torque
 */
...
/**
 * @brief CAN communication callback function
 *
...
void Class_Motor_GM6020::CAN_RxCpltCallback(uint8_t *Rx_Data)
{
    ...
    Flag += 1; //Counts the total number of messages received.

    Pre_Encoder = Rx_Encoder; //Store the Encoder Value

    Rx_Encoder = (Rx_Data[0] << 8) | Rx_Data[1]; //Receive CAN data
...
/**
 * @brief C610 motor initilization
 *
 * @param hcan CAN line number
 * @param __CAN_ID CAN ID
 * @param __Control_Method Motor Control Method, Angle by Default
 * @param __Gearbox_Rate Gearbox Rate, if remove set to 1
 * @param __Torque_Max Max Torque, only used for open loop control
 */
...
/**
 * @brief Send Motor Data to the temporary storage of CAN TX
 *
 */
 ...
 *
 * @return uint16_t Max Output Current
 */
